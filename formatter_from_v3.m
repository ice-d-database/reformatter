...
t.CREP.notes3 = ['Note:<br><br>1. He-3 concentrations have been normalized to CRONUS-P = 5.02e9 atoms/g if possible.<br>' ...
    '<br>'];
t.CREP.notes10 = ['Note:<br><br>1. Be-10 concentrations have been normalized to 07KNSTD.<br>' ...
    '<br>'];
t.CREP.notes36 = '';

t.CC.notes1026 = ['Notes:<br><br>1. The ''scaling method'' input is set to ''ST'' for all lines.<br>' ...
    '2. Be-10/Al-26 concentrations have been converted to 07KNSTD/KNSTD.<br>' ...
    '3. Be-10 and Al-26 measurements for the same sample are on separate lines - there''s not really a universal way to combine them correctly for all possible input configurations.<br>' ...
    '4. A generic value (1013.25) is set in the ''pressure'' field to avoid blank cells.<br>' ...
    '<br>'];
t.CC.notes3 = ['Notes:<br><br>1. The ''scaling method'' input is set to ''ST'' for all lines.<br>' ...
    '2. He-3 concentrations have been normalized to CRONUS-P = 5.02e9 atoms/g if possible.<br>' ...
    '<br>'];
t.CC.notes14 = ['Note:<br><br>1. The ''scaling method'' input is set to ''ST'' for all lines.<br>' ...
    '<br>'];
t.CC.notes36 = '';
