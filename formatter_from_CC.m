...
t.v3.notes = ['Notes: <br><br>1. Atmosphere is set to either ''std'' or ''ant'' based on latitude.<br>' ...
    '2. Latitudes > 180 have been unwrapped.<br>' ...
    '3. Standardizations have been converted to 07KNSTD/KNSTD.<br>' ...
    '4. For He-3, the mineral is arbitrarily set to ''pyroxene'', and there is no standard normalization because that''s not supported by CRONUSCalc input.<br>' ...
    '5. Long sample names may be truncated.<br>' ...
    '7. Erosion rate units have been converted from mm/kyr to cm/yr.<br>' ...
    '<br>'];
t.v3.notes36 = '';

t.CREP.notes3 = ['Notes:<br><br>1. Latitudes > 180 have been unwrapped.<br>' ...
    '2. Erosion rate units have been converted.<br>' ...
    '<br>'];
t.CREP.notes10 = ['Notes:<br><br>1. Latitudes > 180 have been unwrapped.<br>' ...
    '2. Erosion rate units have been converted.<br>' ...
    '<br>'];
t.CREP.notes36 = '';
