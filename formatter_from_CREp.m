...
t.v3.notes = ['Notes: <br><br>1. Atmosphere is set to either ''std'' or ''ant'' based on latitude.<br>' ...
    '2. Collection date is not in CREp input so is arbitrarily set to the beginning of the first Trump administration.<br>' ...
    '3. Be-10 standardization is assumed to be 07KNSTD.<br>' ...
    '4. CREp input has no standardization info for He-3.<br>' ...
    '5. For He-3, the mineral is arbitrarily set to ''pyroxene''.<br>' ...
    '6. Long sample names may be truncated.<br>' ...
    '<br>'];
t.v3.notes36 = '';
...
t.CC.notes1026 = ['Notes:<br><br>1. The ''scaling method'' input is set to ''ST'' for all lines.<br>' ...
    '2. Be-10 concentrations have been assumed on 07KNSTD.<br>' ...
    '3. Long sample names may be truncated.<br>' ...
    '4. Erosion rate units have been converted from cm/yr to mm/kyr.<br>' ...
    '<br>'];
t.CC.notes3 = ['Notes:<br><br>1. The ''scaling method'' input is set to ''ST'' for all lines.<br>' ...
    '2. Long sample names may be truncated.<br>' ...
    '3. Erosion rate units have been converted from cm/yr to mm/kyr<br>' ...
    '<br>'];
t.CC.notes14 = '';
t.CC.notes36 = '';
